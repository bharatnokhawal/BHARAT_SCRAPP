...
def login():
    ...
    time.sleep(1)
    email = "bharatnokhawal201920@gmail.com"  # Replace with your LinkedIn email
    password = "Bharat@456"  # Replace with your LinkedIn password
...
if __name__ == "__main__":
    login()
    first_name = "Bharat"  # Enter the first name of the user you want to search
    last_name = "kumawat"  # Enter the last name of the user you want to search
